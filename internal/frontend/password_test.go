...
func TestServer_UsersPage_AdminSeesChangeActionForEveryRow(t *testing.T) {
	...
	// bare "<details>" tag - the shared shell also renders a settings
	// menu on every page, which would otherwise inflate this count by one
	// regardless of the Users page's own content.
