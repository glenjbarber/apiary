...
// empty-root safety check (ADR-0083) sees a populated root, standing
...
// the ADR-0083 safety check: a jail whose root is a completely empty
...
func TestReconciler_RunOnce_ProvisionsHASTPrimaryForReplicatedJail(t *testing.T) {
	...
	// safety check (ADR-0083) sees an already-populated root, since
