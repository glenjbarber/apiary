...
type JailConsoleTunnelOpen struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *JailConsoleTunnelOpen) Reset() {
	*x = JailConsoleTunnelOpen{}
	mi := &file_api_rpc_manager_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JailConsoleTunnelOpen) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JailConsoleTunnelOpen) ProtoMessage() {}

func (x *JailConsoleTunnelOpen) ProtoReflect() protoreflect.Message {
	mi := &file_api_rpc_manager_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JailConsoleTunnelOpen.ProtoReflect.Descriptor instead.
func (*JailConsoleTunnelOpen) Descriptor() ([]byte, []int) {
	return file_api_rpc_manager_proto_rawDescGZIP(), []int{59}
}

func (x *JailConsoleTunnelOpen) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
type JailConsoleTunnelFrame struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Payload:
	//
	//	*JailConsoleTunnelFrame_Open
	//	*JailConsoleTunnelFrame_Data
	//	*JailConsoleTunnelFrame_Error
	Payload       isJailConsoleTunnelFrame_Payload `protobuf_oneof:"payload"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *JailConsoleTunnelFrame) Reset() {
	*x = JailConsoleTunnelFrame{}
	mi := &file_api_rpc_manager_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JailConsoleTunnelFrame) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JailConsoleTunnelFrame) ProtoMessage() {}

func (x *JailConsoleTunnelFrame) ProtoReflect() protoreflect.Message {
	mi := &file_api_rpc_manager_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JailConsoleTunnelFrame.ProtoReflect.Descriptor instead.
func (*JailConsoleTunnelFrame) Descriptor() ([]byte, []int) {
	return file_api_rpc_manager_proto_rawDescGZIP(), []int{60}
}

func (x *JailConsoleTunnelFrame) GetPayload() isJailConsoleTunnelFrame_Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *JailConsoleTunnelFrame) GetOpen() *JailConsoleTunnelOpen {
	if x != nil {
		if x, ok := x.Payload.(*JailConsoleTunnelFrame_Open); ok {
			return x.Open
		}
	}
	return nil
...
func (x *JailConsoleTunnelFrame) GetData() []byte {
	if x != nil {
		if x, ok := x.Payload.(*JailConsoleTunnelFrame_Data); ok {
			return x.Data
		}
	}
	return nil
...
func (x *JailConsoleTunnelFrame) GetError() string {
	if x != nil {
		if x, ok := x.Payload.(*JailConsoleTunnelFrame_Error); ok {
			return x.Error
		}
	}
	return ""
...
type isJailConsoleTunnelFrame_Payload interface {
	isJailConsoleTunnelFrame_Payload()
}

type JailConsoleTunnelFrame_Open struct {
	Open *JailConsoleTunnelOpen `protobuf:"bytes,1,opt,name=open,proto3,oneof"`
}

type JailConsoleTunnelFrame_Data struct {
	Data []byte `protobuf:"bytes,2,opt,name=data,proto3,oneof"`
}

type JailConsoleTunnelFrame_Error struct {
	Error string `protobuf:"bytes,3,opt,name=error,proto3,oneof"`
}

func (*JailConsoleTunnelFrame_Open) isJailConsoleTunnelFrame_Payload() {}

func (*JailConsoleTunnelFrame_Data) isJailConsoleTunnelFrame_Payload() {}

func (*JailConsoleTunnelFrame_Error) isJailConsoleTunnelFrame_Payload() {}
...
const file_api_rpc_manager_proto_rawDesc = "" +
	...
	"\apayload\"'\n" +
	"\x15JailConsoleTunnelOpen\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"\x8d\x01\n" +
	"\x16JailConsoleTunnelFrame\x12:\n" +
	"\x04open\x18\x01 \x01(\v2$.apiary.rpc.v1.JailConsoleTunnelOpenH\x00R\x04open\x12\x14\n" +
	"\x04data\x18\x02 \x01(\fH\x00R\x04data\x12\x16\n" +
	"\x05error\x18\x03 \x01(\tH\x00R\x05errorB\t\n" +
	"\apayload\"D\n" +
	...
	"\tListJails\x12\x1f.apiary.rpc.v1.ListJailsRequest\x1a .apiary.rpc.v1.ListJailsResponse\x12d\n" +
	"\x10ProxyJailConsole\x12%.apiary.rpc.v1.JailConsoleTunnelFrame\x1a%.apiary.rpc.v1.JailConsoleTunnelFrame(\x010\x01\x12]\n" +
...
var file_api_rpc_manager_proto_goTypes = []any{
	...
	(*JailConsoleTunnelOpen)(nil),               // 71: apiary.rpc.v1.JailConsoleTunnelOpen
	(*JailConsoleTunnelFrame)(nil),              // 72: apiary.rpc.v1.JailConsoleTunnelFrame
	(*GetVMSerialLogRequest)(nil),               // 73: apiary.rpc.v1.GetVMSerialLogRequest
	(*GetVMSerialLogResponse)(nil),              // 74: apiary.rpc.v1.GetVMSerialLogResponse
	(*GetNodeConfigRequest)(nil),                // 75: apiary.rpc.v1.GetNodeConfigRequest
	(*GetNodeConfigResponse)(nil),               // 76: apiary.rpc.v1.GetNodeConfigResponse
	(*NetworkInterface)(nil),                    // 77: apiary.rpc.v1.NetworkInterface
	(*UpdateNodeConfigRequest)(nil),             // 78: apiary.rpc.v1.UpdateNodeConfigRequest
	(*UpdateNodeConfigResponse)(nil),            // 79: apiary.rpc.v1.UpdateNodeConfigResponse
	(*SetDatasetQuotaRequest)(nil),              // 80: apiary.rpc.v1.SetDatasetQuotaRequest
	(*SetDatasetQuotaResponse)(nil),             // 81: apiary.rpc.v1.SetDatasetQuotaResponse
	(*NodeService)(nil),                         // 82: apiary.rpc.v1.NodeService
	(*ListNodeServicesRequest)(nil),             // 83: apiary.rpc.v1.ListNodeServicesRequest
	(*ListNodeServicesResponse)(nil),            // 84: apiary.rpc.v1.ListNodeServicesResponse
	(*RestartNodeServiceRequest)(nil),           // 85: apiary.rpc.v1.RestartNodeServiceRequest
	(*RestartNodeServiceResponse)(nil),          // 86: apiary.rpc.v1.RestartNodeServiceResponse
	(*CreateNetworkRequest)(nil),                // 87: apiary.rpc.v1.CreateNetworkRequest
	(*CreateNetworkResponse)(nil),               // 88: apiary.rpc.v1.CreateNetworkResponse
	(*ListNetworksRequest)(nil),                 // 89: apiary.rpc.v1.ListNetworksRequest
	(*ListNetworksResponse)(nil),                // 90: apiary.rpc.v1.ListNetworksResponse
	(*DeleteNetworkRequest)(nil),                // 91: apiary.rpc.v1.DeleteNetworkRequest
	(*DeleteNetworkResponse)(nil),               // 92: apiary.rpc.v1.DeleteNetworkResponse
	(*CreateJailRequest)(nil),                   // 93: apiary.rpc.v1.CreateJailRequest
	(*CreateJailResponse)(nil),                  // 94: apiary.rpc.v1.CreateJailResponse
	(*UpdateJailRequest)(nil),                   // 95: apiary.rpc.v1.UpdateJailRequest
	(*UpdateJailResponse)(nil),                  // 96: apiary.rpc.v1.UpdateJailResponse
	(*DeleteJailRequest)(nil),                   // 97: apiary.rpc.v1.DeleteJailRequest
	(*DeleteJailResponse)(nil),                  // 98: apiary.rpc.v1.DeleteJailResponse
	(*SetJailDesiredStateRequest)(nil),          // 99: apiary.rpc.v1.SetJailDesiredStateRequest
	(*SetJailDesiredStateResponse)(nil),         // 100: apiary.rpc.v1.SetJailDesiredStateResponse
	(*GetJailRequest)(nil),                      // 101: apiary.rpc.v1.GetJailRequest
	(*GetJailResponse)(nil),                     // 102: apiary.rpc.v1.GetJailResponse
	(*ListJailsRequest)(nil),                    // 103: apiary.rpc.v1.ListJailsRequest
	(*ListJailsResponse)(nil),                   // 104: apiary.rpc.v1.ListJailsResponse
	(*ForcePurgeJailRequest)(nil),               // 105: apiary.rpc.v1.ForcePurgeJailRequest
	(*ForcePurgeJailResponse)(nil),              // 106: apiary.rpc.v1.ForcePurgeJailResponse
	(*MigrateJailRequest)(nil),                  // 107: apiary.rpc.v1.MigrateJailRequest
	(*MigrateJailResponse)(nil),                 // 108: apiary.rpc.v1.MigrateJailResponse
	(*ReportVMPhaseRequest)(nil),                // 109: apiary.rpc.v1.ReportVMPhaseRequest
	(*ReportVMPhaseResponse)(nil),               // 110: apiary.rpc.v1.ReportVMPhaseResponse
	(*ReportVMTeardownCompleteRequest)(nil),     // 111: apiary.rpc.v1.ReportVMTeardownCompleteRequest
	(*ReportVMTeardownCompleteResponse)(nil),    // 112: apiary.rpc.v1.ReportVMTeardownCompleteResponse
	(*ReportJailPhaseRequest)(nil),              // 113: apiary.rpc.v1.ReportJailPhaseRequest
	(*ReportJailPhaseResponse)(nil),             // 114: apiary.rpc.v1.ReportJailPhaseResponse
	(*ReportJailTeardownCompleteRequest)(nil),   // 115: apiary.rpc.v1.ReportJailTeardownCompleteRequest
	(*ReportJailTeardownCompleteResponse)(nil),  // 116: apiary.rpc.v1.ReportJailTeardownCompleteResponse
	(*APIKeyInfo)(nil),                          // 117: apiary.rpc.v1.APIKeyInfo
	(*CreateAPIKeyRequest)(nil),                 // 118: apiary.rpc.v1.CreateAPIKeyRequest
	(*CreateAPIKeyResponse)(nil),                // 119: apiary.rpc.v1.CreateAPIKeyResponse
	(*ListAPIKeysRequest)(nil),                  // 120: apiary.rpc.v1.ListAPIKeysRequest
	(*ListAPIKeysResponse)(nil),                 // 121: apiary.rpc.v1.ListAPIKeysResponse
	(*RevokeAPIKeyRequest)(nil),                 // 122: apiary.rpc.v1.RevokeAPIKeyRequest
	(*RevokeAPIKeyResponse)(nil),                // 123: apiary.rpc.v1.RevokeAPIKeyResponse
	(*SimulateNodeFailureRequest)(nil),          // 124: apiary.rpc.v1.SimulateNodeFailureRequest
	(*SimulateNodeFailureResponse)(nil),         // 125: apiary.rpc.v1.SimulateNodeFailureResponse
	(*QuorumImpact)(nil),                        // 126: apiary.rpc.v1.QuorumImpact
	(*OwnedResourceImpact)(nil),                 // 127: apiary.rpc.v1.OwnedResourceImpact
	(*ReplicaBackedImpact)(nil),                 // 128: apiary.rpc.v1.ReplicaBackedImpact
	(*SimulateNetworkFailureRequest)(nil),       // 129: apiary.rpc.v1.SimulateNetworkFailureRequest
	(*SimulateNetworkFailureResponse)(nil),      // 130: apiary.rpc.v1.SimulateNetworkFailureResponse
	(*TraceCellPathRequest)(nil),                // 131: apiary.rpc.v1.TraceCellPathRequest
	(*PathTraceStep)(nil),                       // 132: apiary.rpc.v1.PathTraceStep
	(*TraceCellPathResponse)(nil),               // 133: apiary.rpc.v1.TraceCellPathResponse
	(*NetworkFailureImpact)(nil),                // 134: apiary.rpc.v1.NetworkFailureImpact
	(*ImageAvailabilityImpact)(nil),             // 135: apiary.rpc.v1.ImageAvailabilityImpact
	(*GetLocalNetworkBridgeStatusRequest)(nil),  // 136: apiary.rpc.v1.GetLocalNetworkBridgeStatusRequest
	(*GetLocalNetworkBridgeStatusResponse)(nil), // 137: apiary.rpc.v1.GetLocalNetworkBridgeStatusResponse
	(*AssumptionKey)(nil),                       // 138: apiary.rpc.v1.AssumptionKey
	(*AssumptionResult)(nil),                    // 139: apiary.rpc.v1.AssumptionResult
...
var file_api_rpc_manager_proto_depIdxs = []int32{
	...
	71,  // 32: apiary.rpc.v1.JailConsoleTunnelFrame.open:type_name -> apiary.rpc.v1.JailConsoleTunnelOpen
	77,  // 33: apiary.rpc.v1.GetNodeConfigResponse.available_interfaces:type_name -> apiary.rpc.v1.NetworkInterface
	82,  // 34: apiary.rpc.v1.ListNodeServicesResponse.services:type_name -> apiary.rpc.v1.NodeService
	15,  // 35: apiary.rpc.v1.CreateNetworkRequest.network:type_name -> apiary.rpc.v1.NetworkDefinition
	15,  // 36: apiary.rpc.v1.CreateNetworkResponse.network:type_name -> apiary.rpc.v1.NetworkDefinition
	15,  // 37: apiary.rpc.v1.ListNetworksResponse.networks:type_name -> apiary.rpc.v1.NetworkDefinition
	15,  // 38: apiary.rpc.v1.DeleteNetworkResponse.network:type_name -> apiary.rpc.v1.NetworkDefinition
	13,  // 39: apiary.rpc.v1.CreateJailRequest.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 40: apiary.rpc.v1.CreateJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 41: apiary.rpc.v1.UpdateJailRequest.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 42: apiary.rpc.v1.UpdateJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 43: apiary.rpc.v1.DeleteJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	2,   // 44: apiary.rpc.v1.SetJailDesiredStateRequest.desired_state:type_name -> apiary.rpc.v1.JailState
	13,  // 45: apiary.rpc.v1.SetJailDesiredStateResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 46: apiary.rpc.v1.GetJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 47: apiary.rpc.v1.ListJailsResponse.jails:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 48: apiary.rpc.v1.ForcePurgeJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	13,  // 49: apiary.rpc.v1.MigrateJailResponse.jail:type_name -> apiary.rpc.v1.JailDefinition
	1,   // 50: apiary.rpc.v1.ReportVMPhaseRequest.phase:type_name -> apiary.rpc.v1.VMPhase
	3,   // 51: apiary.rpc.v1.ReportJailPhaseRequest.phase:type_name -> apiary.rpc.v1.JailPhase
	117, // 52: apiary.rpc.v1.CreateAPIKeyResponse.key:type_name -> apiary.rpc.v1.APIKeyInfo
	117, // 53: apiary.rpc.v1.ListAPIKeysResponse.keys:type_name -> apiary.rpc.v1.APIKeyInfo
	126, // 54: apiary.rpc.v1.SimulateNodeFailureResponse.quorum:type_name -> apiary.rpc.v1.QuorumImpact
	127, // 55: apiary.rpc.v1.SimulateNodeFailureResponse.owned_resources:type_name -> apiary.rpc.v1.OwnedResourceImpact
	128, // 56: apiary.rpc.v1.SimulateNodeFailureResponse.replica_backed_resources:type_name -> apiary.rpc.v1.ReplicaBackedImpact
	135, // 57: apiary.rpc.v1.SimulateNodeFailureResponse.image_availability:type_name -> apiary.rpc.v1.ImageAvailabilityImpact
	41,  // 58: apiary.rpc.v1.SimulateNodeFailureResponse.relevant_claims:type_name -> apiary.rpc.v1.AssumptionClaim
	4,   // 59: apiary.rpc.v1.OwnedResourceImpact.kind:type_name -> apiary.rpc.v1.ResourceKind
	5,   // 60: apiary.rpc.v1.OwnedResourceImpact.verdict:type_name -> apiary.rpc.v1.RecoveryVerdict
	4,   // 61: apiary.rpc.v1.ReplicaBackedImpact.kind:type_name -> apiary.rpc.v1.ResourceKind
	15,  // 62: apiary.rpc.v1.SimulateNetworkFailureResponse.network:type_name -> apiary.rpc.v1.NetworkDefinition
	134, // 63: apiary.rpc.v1.SimulateNetworkFailureResponse.affected_resources:type_name -> apiary.rpc.v1.NetworkFailureImpact
	6,   // 64: apiary.rpc.v1.PathTraceStep.status:type_name -> apiary.rpc.v1.PathTraceStatus
	12,  // 65: apiary.rpc.v1.TraceCellPathResponse.cell:type_name -> apiary.rpc.v1.VMDefinition
	15,  // 66: apiary.rpc.v1.TraceCellPathResponse.network:type_name -> apiary.rpc.v1.NetworkDefinition
	6,   // 67: apiary.rpc.v1.TraceCellPathResponse.status:type_name -> apiary.rpc.v1.PathTraceStatus
	132, // 68: apiary.rpc.v1.TraceCellPathResponse.steps:type_name -> apiary.rpc.v1.PathTraceStep
	7,   // 69: apiary.rpc.v1.ImageAvailabilityImpact.role:type_name -> apiary.rpc.v1.ImageRole
	8,   // 70: apiary.rpc.v1.ImageAvailabilityImpact.verdict:type_name -> apiary.rpc.v1.ImageAvailabilityVerdict
	9,   // 71: apiary.rpc.v1.AssumptionKey.kind:type_name -> apiary.rpc.v1.AssumptionKind
	11,  // 72: apiary.rpc.v1.AssumptionKey.subject_kind:type_name -> apiary.rpc.v1.AssumptionSubjectKind
	138, // 73: apiary.rpc.v1.AssumptionResult.key:type_name -> apiary.rpc.v1.AssumptionKey
	10,  // 74: apiary.rpc.v1.AssumptionResult.observed_status:type_name -> apiary.rpc.v1.AssumptionStatus
	10,  // 75: apiary.rpc.v1.AssumptionResult.status:type_name -> apiary.rpc.v1.AssumptionStatus
	138, // 76: apiary.rpc.v1.AssumptionHistoryEntry.key:type_name -> apiary.rpc.v1.AssumptionKey
	10,  // 77: apiary.rpc.v1.AssumptionHistoryEntry.observed_status:type_name -> apiary.rpc.v1.AssumptionStatus
...
func file_api_rpc_manager_proto_init() {
	...
	file_api_rpc_manager_proto_msgTypes[60].OneofWrappers = []any{
		(*JailConsoleTunnelFrame_Open)(nil),
		(*JailConsoleTunnelFrame_Data)(nil),
		(*JailConsoleTunnelFrame_Error)(nil),
	}
	file_api_rpc_manager_proto_msgTypes[64].OneofWrappers = []any{}
	file_api_rpc_manager_proto_msgTypes[66].OneofWrappers = []any{}
	file_api_rpc_manager_proto_msgTypes[129].OneofWrappers = []any{}
	type x struct{}
